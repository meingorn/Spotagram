...
function loadPics() {
  var url = "https://api.flickr.com/services/rest/?method=flickr.interestingness.getList&api_key=1d8d38fe92286045c8cd4e4c48cdf529&safe_search=1&per_page=300"
...
//   var url = "https://api.flickr.com/services/rest/?method=flickr.interestingness.getList&api_key=1d8d38fe92286045c8cd4e4c48cdf529&safe_search=2&per_page=60"
//   $.getJSON(url + "&format=json&jsoncallback=?", function(data) {
//     $.each(data.photos.photo, function(i, item){
//
//       let src = `http://farm${item.farm}.static.flickr.com/${item.server}/${item.id}_${item.secret}_m.jpg`;
